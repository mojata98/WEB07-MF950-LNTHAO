...
export default {
  ...
  methods: {
    ...
    getCoordinate(index, employee, pageSize){
      ...
      console.log(this.passToContextMenu.index);
      console.log(this.passToContextMenu.employeeObject);
      console.log(this.passToContextMenu.pageSize);
